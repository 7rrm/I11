 ...
 * يحتوي على 472 مفتاح مع الدعم الكامل
 */
public final class MeeroStrings {
    ...
    static {
        ...
        put("MeeroAuditIntegrityOk", "Chain verified ✓ All %251$d sealed attempts are intact.", "التحقق تم ✓ — كل المحاولات المختومة (%251$d) سليمة");
        put("MeeroAuditIntegrityBad", "Tamper detected - the first broken seal is at entry %251$d", "عبث مكتشف — أول ختم مكسور عند القياس %251$d");
